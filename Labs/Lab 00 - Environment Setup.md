...
**Prereq:** Everything on the [Lab Prerequisites](Lab%20Prerequisites.md)
...
```bash
git clone <REPO-URL>
cd nordic-summit2026-agentic-workshop
```
...
Move to [Lab 01 - Dataverse Foundation](Lab%2001%20-%20Dataverse%20Foundation.md).
