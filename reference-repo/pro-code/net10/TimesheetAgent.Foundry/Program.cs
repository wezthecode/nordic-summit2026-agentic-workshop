...
var promptsDirectory = config["Prompts:Directory"]
    ?? Path.Combine(AppContext.BaseDirectory, "..", "..", "..", "..", "..", "..", "workshop", "shared-assets", "prompts");
...
// --scenario <name> loads a single scenario from shared-assets/eval/scenarios.json and runs it
...
static class ScenarioLoader
{
    ...
    {
        var scenariosPath = Path.Combine(promptsDirectory, "..", "eval", "scenarios.json");
