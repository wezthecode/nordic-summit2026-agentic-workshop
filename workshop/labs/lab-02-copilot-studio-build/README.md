...
**Authoritative prompts:** [`shared-assets/prompts/`](../../shared-assets/prompts/) — copy these verbatim
...
This is the low-code half of the comparison. Lab 03 rebuilds the same thing with the .NET Agent Framework SDK on Foundry. Lab 04 puts them side by side. The prompts in `shared-assets/prompts/` are the **identical text** used by both builds — that's the whole point of the comparison.
...
- **Instructions:** paste [`shared-assets/prompts/calendar-child.system.md`](../../shared-assets/prompts/calendar-child.system.md) verbatim
...
- **Instructions:** paste [`shared-assets/prompts/orchestrator.system.md`](../../shared-assets/prompts/orchestrator.system.md) verbatim
- **Knowledge:** none
...
Pick `happy-path-last-week` and `duplicate-event-rejection` from [`shared-assets/eval/scenarios.json`](../../shared-assets/eval/scenarios.json). Manually drive them through the Preview tab. Confirm:
...
Move to [lab-03-foundry-build](../lab-03-foundry-build/).
