...
2. **5 min — show a prompt change in both runtimes.** Edit a line of `orchestrator.system.md` in `shared-assets/`. Walk through how that change flows into each runtime. (Copilot Studio: copy-paste, re-publish. Foundry: edit file, `git commit`, redeploy.) Time both, write the seconds on the board.
...
Move to [lab-05-evaluation](../lab-05-evaluation/).
